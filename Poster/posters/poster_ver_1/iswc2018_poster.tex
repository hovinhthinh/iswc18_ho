...
\keywords{Rule Learning from Knowledge Graphs Guided by Embedding Models}
...
%       \put(-100,-180){\includegraphics[width=.6\textwidth]{kb}}
%    \end{picture}
% \begin{picture}(1.99,1.99)
%       \put(-320,-630){\includegraphics[width=.96\textwidth]{kg_2}}
% \end{picture}
%  \end{column}
...
% \begin{picture}(1.99,1.99)
%       \put(520,450){\includegraphics[width=.542\textwidth]{big_pic}}
% \end{picture}
...
% \begin{center}\includegraphics[width=.85\textwidth]{subs}\\
...
% \begin{picture}(1.99,1.99)
%       \put(745,470){\includegraphics[width=.35\textwidth]{big_pic_exp}}
% \end{picture}
% \begin{picture}(1.99,1.99)
%       \put(895,-70){\includegraphics[width=.15\textwidth]{imdb}}
% \end{picture}
% \bigskip
% \bigskip
...
\setbeamercolor{uppercolblue}{fg=black,bg=darkbl!35}
\setbeamercolor{lowercolblue}{fg=black,bg=darkbl!12}
...
\begin{center}Mine rules with support from KG embeddings\end{center}
			...
			\begin{block}{3. Embedding-based Rule Evaluation}
				\begin{picture}(1.99,1.99)
					\put(500,-650){\includegraphics[width=.6\textwidth]{kg_text}}
				\end{picture}
				\small
				\begin{itemize}
					\bigskip
		...
		\begin{column}{.5\textwidth}
				...
				\begin{columns}
					\begin{column}{.9\textwidth}
						...
						\begin{itemize}
							...
							\item Measure the \bl{\textbf{predictive quality} \pmb{$\mu_2$}} of $\cG_r$ relying on $\mathcal{P}=(\cG,f)$:
			...
			\begin{block}{4. Non-monotonic Rule Mining with Embedding Support}
				\begin{center}
					\includegraphics[width=.8\textwidth,height=27.5cm]{mining}					
				\end{center}				
			\end{block}
		\end{column}
	\end{columns}
	...
	\begin{columns}[t]
		\begin{column}{.5\textwidth}
			\begin{block}{5. Rule Refinement and Filters}						
				\begin{picture}(1.99,1.99)
					\put(325,-500){\includegraphics[width=.72\textwidth,height=16.5cm]{refinement_operators-crop}}
				\end{picture}
				\begin{columns}[t]
		...
		\begin{column}{0.5\textwidth}
			...
			\begin{block}{6. Experiments}
				\begin{picture}(1.99,1.99)
					\put(860,-225){\includegraphics[width=.27\textwidth]{wikidata}}
				\end{picture}
				\begin{picture}(1.99,1.99)
					\put(475,-150){\includegraphics[width=.33\textwidth,height=3.5cm]{freebase}}
				\end{picture}
				...
				\begin{columns}
					\begin{column}{1.02\textwidth}
						...
						\begin{figure}[t]
							...
							\subfloat{{\includegraphics[width=0.5\textwidth]{figures/new_exp1/legend-crop.pdf} }}\\
							...
							\subfloat[Conf-SSP on FB15K]{{\includegraphics[width=0.24\textwidth]{figures/new_exp1/fb15k_ssp_conf-crop.pdf} \label{fig:fb-SSP-Conf}}}
							%\subfloat[RulES-H-PCA on FB15K]{{\includegraphics[width=0.3\textwidth]{figures/fb15k_hole_pca-crop.pdf} }}
							\subfloat[PCA-SSP on FB15K]{{\includegraphics[width=0.24\textwidth]{figures/new_exp1/fb15k_ssp_pca-crop.pdf} }\label{fig:fb-SSP-PCA}}    
							...
							\subfloat[Conf-SSP on Wiki44K]{{\includegraphics[width=0.24\textwidth]{figures/new_exp1/wiki44k_ssp_conf-crop.pdf} }\label{fig:wi-SSP-Conf}}
							%\subfloat[RulES-H-PCA on Wiki44K]{{\includegraphics[width=0.3\textwidth]{figures/wiki44k_transe_pca-crop.pdf} }}
							\subfloat[PCA-SSP on Wiki44K]{{\includegraphics[width=0.24\textwidth]{figures/new_exp1/wiki44k_ssp_pca-crop.pdf} }\label{fig:wi-SSP-PCA}}
	...
	\begin{tikzpicture}[remember picture,overlay]
		\node[] at (40.5,119.5) {%
			\begin{tabular}{c}
				...
				\bigskip                                                                                                                               
				                                                                                                                                       \\
				\textbf{\huge{Rule Learning from Knowledge Graphs}}                                                                                    \\
				\textbf{\huge{Guided by Embedding Models}}\bigskip                                                                                     \\
